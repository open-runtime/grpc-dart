    ...
    group('client-errors', () {
      serverTest('no-settings-frame-at-beginning', (
        ...
        Future clientFun() async {
          ...
          expect(
            await nextFrame(),
            isA<GoawayFrame>().having((f) => f.errorCode, 'errorCode', ErrorCode.PROTOCOL_ERROR),
          );
      ...
      serverTest('data-frame-after-stream-closed', (
        ...
        Future clientFun() async {
          ...
          clientWriter.writeHeadersFrame(3, [Header.ascii('a', 'b')], endStream: true);
    ...
    group('server-errors', () {
      serverTest('server-resets-stream', (
        ...
        Future clientFun() async {
          ...
          clientWriter.writeHeadersFrame(1, [Header.ascii('a', 'b')], endStream: false);
...
void serverTest(
  ...
  return test(name, () {
    ...
    return func(streams.serverConnection, streams.clientConnectionFrameWriter, clientReader, readNext);
  });
}
...
class ClientErrorStreams {
  ...
  ServerTransportConnection get serverConnection => ServerTransportConnection.viaStreams(readB, writeA);
}
