...
void main() {
  group('frames', () {
    group('writer-reader', () {
      writerReaderTest('data-frame', (FrameWriter writer, FrameReader reader, HPackDecoder decoder) async {
      ...
      writerReaderTest('headers-frame', (FrameWriter writer, FrameReader reader, HPackDecoder decoder) async {
      ...
      writerReaderTest('priority-frame', (FrameWriter writer, FrameReader reader, HPackDecoder decoder) async {
      ...
      writerReaderTest('rst-frame', (FrameWriter writer, FrameReader reader, HPackDecoder decoder) async {
      ...
      writerReaderTest('settings-frame', (FrameWriter writer, FrameReader reader, HPackDecoder decoder) async {
        ...
        expect(settingsFrame.settings[0].identifier, Setting.SETTINGS_ENABLE_PUSH);
        expect(settingsFrame.settings[0].value, 1);
      });

      writerReaderTest('settings-frame-ack', (FrameWriter writer, FrameReader reader, HPackDecoder decoder) async {
      ...
      writerReaderTest('push-promise-frame', (FrameWriter writer, FrameReader reader, HPackDecoder decoder) async {
      ...
      writerReaderTest('ping-frame', (FrameWriter writer, FrameReader reader, HPackDecoder decoder) async {
      ...
      writerReaderTest('goaway-frame', (FrameWriter writer, FrameReader reader, HPackDecoder decoder) async {
      ...
      writerReaderTest('window-update-frame', (FrameWriter writer, FrameReader reader, HPackDecoder decoder) async {
      ...
      writerReaderTest('frag-headers-frame', (FrameWriter writer, FrameReader reader, HPackDecoder decoder) async {
        var headerName = [1];
        ...
        var headerBlock = <int>[...headersFrame.headerBlockFragment, ...contFrame.headerBlockFragment];
...
void writerReaderTest(String name, Future<void> Function(FrameWriter, FrameReader, HPackDecoder) func) {
  test(name, () {
...
Future<List<Frame>> finishWriting(FrameWriter writer, FrameReader reader) {
  return Future.wait([writer.close(), reader.startDecoding().toList()]).then((results) => results.last as List<Frame>);
}
