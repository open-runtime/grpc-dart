  ...
  group('Server with server interceptor', () {
    group('processes calls if interceptor allows request', () {
      ...
      test(
        ...
        () => doTest((call, method, requests) async => interceptor(call, method, requests)),
      );
    });
    ...
    group('returns error if interceptor blocks request', () {
      ...
      test('with sync interceptor', () => doTest(interceptor));
      test('with async interceptor', () => doTest((call, method, request) async => interceptor(call, method, request)));
    });
    ...
    group('serviceInterceptors are invoked', () {
      ...
      test('multiple serviceInterceptors are invoked', () async {
        ...
        expect(invocationsOrderRecords, equals(['Start 1', 'Start 2', 'Data 2 [7]', 'Data 1 [7]', 'Done 2', 'Done 1']));
      });
    });
    ...
    test('can modify response', () async {
      ...
      expect(invocationsOrderRecords, equals(['Start 1', 'Start 2', 'Data 2 [7]', 'Data 1 [14]', 'Done 2', 'Done 1']));
    });
  });
}
