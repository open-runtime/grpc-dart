...
void main() {
  ...
  test('Stream handles trailers properly', () async {
    ...
    final stream = connection.makeRequest(
        'test_path', Duration(seconds: 10), requestHeaders, (error, _) => fail(error.toString()));
  ...
  test('Stream receives multiple messages', () async {
    ...
    final stream =
        connection.makeRequest('test_path', Duration(seconds: 10), metadata, (error, _) => fail(error.toString()));
