...
void main() {
  group('Certificates', () {
    test('report password errors correctly', () async {
      ...
      final missingPassword = ChannelCredentials.secure(certificates: certificates);
      expect(() => missingPassword.securityContext, throwsA(isTlsException));

      final wrongPassword = ChannelCredentials.secure(certificates: certificates, password: 'wrong');
      expect(() => wrongPassword.securityContext, throwsA(isTlsException));

      final correctPassword = ChannelCredentials.secure(certificates: certificates, password: 'correct');
