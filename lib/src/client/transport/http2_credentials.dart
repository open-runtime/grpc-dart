...
class ChannelCredentials {
  ...
  const ChannelCredentials._(
      this.isSecure, this._certificateBytes, this._certificatePassword, this.authority, this.onBadCertificate);
  ...
  const ChannelCredentials.secure(
      {List<int>? certificates, String? password, String? authority, BadCertificateHandler? onBadCertificate})
