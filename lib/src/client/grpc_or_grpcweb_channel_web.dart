...
class GrpcOrGrpcWebClientChannelInternal extends GrpcWebClientChannel {
  ...
  GrpcOrGrpcWebClientChannelInternal.grpc(Object host, {required int port, required ChannelOptions options})
    : super.xhr(Uri(host: host.toString(), port: port, scheme: options.credentials.isSecure ? 'https' : 'http')) {
