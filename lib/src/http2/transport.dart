...
import 'hpack/hpack.dart' show Header;

export 'frames/frames.dart' show ErrorCode;
export 'hpack/hpack.dart' show Header;
...
abstract class ServerTransportConnection extends TransportConnection {
  factory ServerTransportConnection.viaSocket(Socket socket, {ServerSettings? settings}) {
    return ServerTransportConnection.viaStreams(socket, socket, settings: settings);
  }
...
class TransportStreamPush {
  ...
  @override
  String toString() => 'TransportStreamPush(${requestHeaders.length} request headers headers)';
}
