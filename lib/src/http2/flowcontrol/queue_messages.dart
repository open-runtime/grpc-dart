...
class HeadersMessage extends Message {
  ...
  HeadersMessage(int streamId, this.headers, bool endStream) : super(streamId, endStream);

  @override
  String toString() => 'HeadersMessage(headers: ${headers.length}, endStream: $endStream)';
}

class DataMessage extends Message {
  final List<int> bytes;

  DataMessage(int streamId, this.bytes, bool endStream) : super(streamId, endStream);

  @override
  String toString() => 'DataMessage(bytes: ${bytes.length}, endStream: $endStream)';
}
...
class PushPromiseMessage extends Message {
  ...
  PushPromiseMessage(int streamId, this.headers, this.promisedStreamId, this.pushedStream, bool endStream)
...
class GoawayMessage extends Message {
  ...
  GoawayMessage(this.lastStreamId, this.errorCode, this.debugData) : super(0, false);
