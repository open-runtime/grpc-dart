...
final $typed_data.Uint8List deleteLogRequestDescriptor =
    $convert.base64Decode('ChBEZWxldGVMb2dSZXF1ZXN0Ej0KCGxvZ19uYW1lGAEgASgJQiLgQQL6QRwKGmxvZ2dpbmcuZ2'
...
final $typed_data.Uint8List writeLogEntriesRequestDescriptor =
    $convert.base64Decode('ChZXcml0ZUxvZ0VudHJpZXNSZXF1ZXN0Ej0KCGxvZ19uYW1lGAEgASgJQiLgQQH6QRwKGmxvZ2'
  ...
  '2': [
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.google.logging.v2.WriteLogEntriesPartialErrors.LogEntryErrorsEntry',
      '10': 'logEntryErrors'
    },
  ],
...
final $typed_data.Uint8List writeLogEntriesPartialErrorsDescriptor =
    $convert.base64Decode('ChxXcml0ZUxvZ0VudHJpZXNQYXJ0aWFsRXJyb3JzEm0KEGxvZ19lbnRyeV9lcnJvcnMYASADKA'
...
final $typed_data.Uint8List listLogEntriesRequestDescriptor =
    $convert.base64Decode('ChVMaXN0TG9nRW50cmllc1JlcXVlc3QSSQoOcmVzb3VyY2VfbmFtZXMYCCADKAlCIuBBAvpBHB'
...
final $typed_data.Uint8List listLogEntriesResponseDescriptor =
    $convert.base64Decode('ChZMaXN0TG9nRW50cmllc1Jlc3BvbnNlEjUKB2VudHJpZXMYASADKAsyGy5nb29nbGUubG9nZ2'
...
final $typed_data.Uint8List listMonitoredResourceDescriptorsRequestDescriptor =
    $convert.base64Decode('CidMaXN0TW9uaXRvcmVkUmVzb3VyY2VEZXNjcmlwdG9yc1JlcXVlc3QSIAoJcGFnZV9zaXplGA'
...
final $typed_data.Uint8List listMonitoredResourceDescriptorsResponseDescriptor =
    $convert.base64Decode('CihMaXN0TW9uaXRvcmVkUmVzb3VyY2VEZXNjcmlwdG9yc1Jlc3BvbnNlEloKFHJlc291cmNlX2'
...
final $typed_data.Uint8List listLogsRequestDescriptor =
    $convert.base64Decode('Cg9MaXN0TG9nc1JlcXVlc3QSOgoGcGFyZW50GAEgASgJQiLgQQL6QRwSGmxvZ2dpbmcuZ29vZ2'
...
final $typed_data.Uint8List listLogsResponseDescriptor =
    $convert.base64Decode('ChBMaXN0TG9nc1Jlc3BvbnNlEhsKCWxvZ19uYW1lcxgDIAMoCVIIbG9nTmFtZXMSJgoPbmV4dF'
...
final $typed_data.Uint8List tailLogEntriesRequestDescriptor =
    $convert.base64Decode('ChVUYWlsTG9nRW50cmllc1JlcXVlc3QSKgoOcmVzb3VyY2VfbmFtZXMYASADKAlCA+BBAlINcm'
...
final $typed_data.Uint8List tailLogEntriesResponseDescriptor =
    $convert.base64Decode('ChZUYWlsTG9nRW50cmllc1Jlc3BvbnNlEjUKB2VudHJpZXMYASADKAsyGy5nb29nbGUubG9nZ2'
